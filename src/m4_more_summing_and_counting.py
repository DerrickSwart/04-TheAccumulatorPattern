...
import math
import builtins  # Never necessary, but here for pedagogical reason
...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 2
    answer = count_cosines_from(6, 9, 0.1)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
    # Test 4:
    expected = 4
    answer = count_cosines_from(4, 9, -0.3)
    ...
    # Test 6:
    expected = 1
    answer = count_cosines_from(6, 6, 0.5)
